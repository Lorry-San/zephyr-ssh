...
rdpH264Wss.on('connection', async (ws, req) => {
    ...
    try {
        ...
        pipe.clients.add(ws);
        ws.send(JSON.stringify({ type: 'hello', container: 'webm', codec: 'vp8', width: pipe.width || RDP_STREAM_WIDTH, height: pipe.height || RDP_STREAM_HEIGHT, fps: RDP_STREAM_FPS }));
